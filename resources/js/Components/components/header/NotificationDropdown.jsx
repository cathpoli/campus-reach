                ...
                >
                  <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                    {notification.sender?.avatar ? (
                      ...
                      <div className="flex items-center justify-center w-full h-full overflow-hidden text-white bg-blue-500 rounded-full">
                        <span className="text-lg font-semibold">
                          {getUserInitial(notification.sender?.name)}
                        </span>
                      </div>
                    )}
                  ...
                  <span className="block">
                    <span className="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400">
                      ...
                      <span className="ml-1">{notification.message.replace(notification.sender?.name, '').trim()}</span>
                    </span>
